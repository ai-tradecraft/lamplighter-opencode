...
.PHONY: help doctor install-deps setup ci lint qa run-chat-through-harness stop-chat-through-harness test-chat-through-harness test-real-backend print-real-backend-fingerprint check-uv
